...
<<<<<<< HEAD
    ...
    {L"gd25lq128E",
     ...
     64 * 1024,
     256,
     NOR_FLASH_ERASE_4K}, // need revise back datasheet
    /* ISSI */
    ...
    {L"n25q512",
     ...
     64 * 1024,
     1024,
     NOR_FLASH_WRITE_FSR | NOR_FLASH_ERASE_4K},
    {L"n25q512a",
     {0x20, 0xbb, 0x20},
     3,
     256,
...
EFI_STATUS
EFIAPI
NorFlashGetInfo(IN UINT8 *Id, IN OUT NOR_FLASH_INFO **FlashInfo,
...
VOID EFIAPI NorFlashPrintInfo(IN NOR_FLASH_INFO *Info) {
  ...
  DEBUG((DEBUG_ERROR,
         "Detected %s SPI NOR flash with page size %d B, erase size %d KB, "
         "total %d MB\n",
         Info->Name, Info->PageSize, EraseSize / 1024,
